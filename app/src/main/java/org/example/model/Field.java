...
public class Field {
    ...
    public Field(byte[] accessFlags, short nameIndex, short descriptorIndex, Attribute[] attributes) {
    ...
    public String toString(ConstantPool constantPool) {
        ...
        sb.append("\t\taccessFlags ").append(bufToStr(accessFlags)).append("\n");
    ...
    private String bufToStr(byte[] bytes) {
        var sb = new StringBuilder();
        sb.append("[ ");
        for (var b : bytes) {
